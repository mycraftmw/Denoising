...
/**
 * The <code>NoiseRemoverRemote</code> class provides a Java RMI-compliant interface to 
 * the M-functions from the files:
 * <pre>
 *  D:\\code\\repository\\Denoising\\code2\\PA.m
 *  D:\\code\\repository\\Denoising\\code2\\RemovalNoise.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>NoiseRemoverRemote</code> 
 ...
 * generate RMI server proxy objects for instances of NoiseRemover.NoiseRemover.
 */
public interface NoiseRemoverRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>PA</code> M-function with 1 
     * input argument.  
     *
     ...
     */
    public Object[] PA(int nargout, Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] RemovalNoise(int nargout, Object... rhs) throws RemoteException;
